 ...
 * Default value: 1
 */
#define DEF_NUM_CHANNELS (uint16_t) ((uint16_t)2u<<2u)
...
{                                                                                                                  \
   { X(14),X(15),X(16),X(17) }, Y(3), 0, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_4), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
#define GRP_1_4P_PARAMS                                                                                               \
{                                                                                                                  \
   { X(14),X(15),X(16),X(17) }, Y(2), 0, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_4), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
...
extern qtm_acq_4p_saml10_config_t ptc_seq_node_cfg1[DEF_NUM_CHANNELS >> 2];
