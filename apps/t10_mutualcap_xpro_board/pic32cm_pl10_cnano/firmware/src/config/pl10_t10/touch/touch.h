...
{                                                                                                                  \
 X(19), Y(29), 8, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_1_PARAMS                                                                                               \
{                                                                                                                  \
 X(18), Y(29), 5, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_2_PARAMS                                                                                               \
{                                                                                                                  \
 X(5), Y(29), 10, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_3_PARAMS                                                                                               \
{                                                                                                                  \
 X(17), Y(29), 8, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_4_PARAMS                                                                                               \
{                                                                                                                  \
 X(19), Y(4), 10, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_5_PARAMS                                                                                               \
{                                                                                                                  \
 X(18), Y(4), 10, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_6_PARAMS                                                                                               \
{                                                                                                                  \
 X(5), Y(4), 10, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_7_PARAMS                                                                                               \
{                                                                                                                  \
 X(17), Y(4), 10, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_1), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
...
#define KEY_0_PARAMS                                                                                            \
{                                                                                                              \
    50u, (uint8_t)HYST_25, (uint8_t)NO_AKS_GROUP                       \
}


#define KEY_1_PARAMS                                                                                            \
{                                                                                                              \
    25u, (uint8_t)HYST_25, (uint8_t)NO_AKS_GROUP                       \
}
...
#define KEY_5_PARAMS                                                                                            \
{                                                                                                              \
    80u, (uint8_t)HYST_25, (uint8_t)AKS_GROUP_1                       \
}
...
{                                                                                                              \
    (uint8_t)SCROLLER_TYPE_SLIDER, 4u, 4u,                            \
		SCROLLER_RESOL_DEADBAND((uint8_t)SCR_RESOL_8_BIT, (uint8_t)SCR_DB_10_PERCENT),(uint8_t)8,70\
}
