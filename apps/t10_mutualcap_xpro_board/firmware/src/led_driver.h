...
#if __ATSAMC21J18A__
#define __I2C_CallbackRegister(x,y) SERCOM2_I2C_CallbackRegister(x,y)
#define __I2C_Write(x,y,z) SERCOM2_I2C_Write(x,y,z)
#define __I2C_ErrorGet() SERCOM2_I2C_ErrorGet()
#endif
