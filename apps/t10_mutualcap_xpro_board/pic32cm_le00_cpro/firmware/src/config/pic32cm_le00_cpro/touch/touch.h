...
{                                                                                                                  \
 X(28), Y(3), 0, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_4), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
#define NODE_3_PARAMS                                                                                               \
{                                                                                                                  \
 X(27), Y(3), 0, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_4), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
...
{                                                                                                                  \
 X(28), Y(2), 0, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_4), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
#define NODE_7_PARAMS                                                                                               \
{                                                                                                                  \
 X(27), Y(2), 0, NODE_RSEL_PRSC(RSEL_VAL_0, (uint8_t)PRSC_DIV_SEL_4), NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
