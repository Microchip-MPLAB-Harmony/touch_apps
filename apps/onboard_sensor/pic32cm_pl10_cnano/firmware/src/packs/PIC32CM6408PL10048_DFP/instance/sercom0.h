...
#ifndef _PIC32CMPL10_SERCOM0_INSTANCE_
#define _PIC32CMPL10_SERCOM0_INSTANCE_
...
#define SERCOM0_GCLK_ID_CORE                     (6)
#define SERCOM0_GCLK_ID_SLOW                     (5)
#define SERCOM0_INSTANCE_ID                      (65)       /* Instance index for SERCOM0 */
#define SERCOM0_INT_MSB                          (6)
#define SERCOM0_PMSB                             (3)

#endif /* _PIC32CMPL10_SERCOM0_INSTANCE_ */
