...
extern qtm_acq_samc21_node_config_t  ptc_seq_node_cfg1[DEF_NUM_CHANNELS];
...
uint8_t proj_config[PROJECT_CONFIG_DATA_LEN] = {  samc2x,  (DEF_NUM_CHANNELS), (KEYS_MODULE|SCROLLER_MODULE|FREQ_HOP_AUTO_TUNE_MODULE),
...
{
	qtm_acq_samc21_node_config_t *ptr = &ptc_seq_node_cfg1[channel];
...
void UART_Write(uint8_t data) {
	...
	txData = data;
	SERCOM4_USART_Write(&txData, 1); // sam devices
}
