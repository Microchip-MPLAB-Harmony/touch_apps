...
Path of the application within the repository is **apps/qt1_selfcap_xpro_board/sam_d20_xpro**
...
| ----------------- | ---------------------------------------------- |
| qt1_selfcap_xpro_board/sam_d20_xpro/sam_d20_xpro.X    | MPLABX Project for [SAM D20 Xplained Pro Evaluation Kit](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNo/ATSAMD20-XPRO)|
|||
