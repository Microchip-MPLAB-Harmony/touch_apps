...
Path of the application within the repository is **apps/qt1_selfcap_xpro_board/sam_da1_xpro**
...
| ----------------- | ---------------------------------------------- |
| qt1_selfcap_xpro_board/sam_da1_xpro/sam_da1_xpro.X    | MPLABX Project for [SAM DA1 Xplained Pro Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/atsamda1-xpro)|
|||
...
1. Open the application project *sam_da1_xpro.X* in the IDE
