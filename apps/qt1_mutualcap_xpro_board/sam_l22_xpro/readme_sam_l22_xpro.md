...
Path of the application within the repository is **apps/qt1_mutualcap_xpro_board/sam_l22_xpro/**
...
| ----------------- | ---------------------------------------------- |
| qt1_mutualcap_xpro_board/sam_l22_xpro/sam_l22_xpro.X    | MPLABX Project for [SAM L22 Xplained Pro Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/PartNO/ATSAML22-XPRO-B)|
|||
