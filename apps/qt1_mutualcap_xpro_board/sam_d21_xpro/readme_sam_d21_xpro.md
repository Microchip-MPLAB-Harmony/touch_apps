...
Path of the application within the repository is **apps/qt1_mutualcap_xpro_board/sam_d21_xpro/**
...
| ----------------- | ---------------------------------------------- |
| qt1_mutualcap_xpro_board/sam_d21_xpro/sam_d21_xpro.X    | MPLABX Project for [SAM D21 Xplained Pro Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/atsamd21-xpro)|
|||
