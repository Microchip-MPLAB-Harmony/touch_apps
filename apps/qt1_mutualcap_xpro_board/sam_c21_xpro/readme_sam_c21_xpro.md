...
Path of the application within the repository is **apps/qt1_mutualcap_xpro_board/sam_c21_xpro/**
...
| ----------------- | ---------------------------------------------- |
| qt1_mutualcap_xpro_board/sam_c21_xpro/sam_c21_xpro.X    | MPLABX Project for [SAM C21 Xplained Pro Evaluation Kit](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNo/ATSAMC21-XPRO)|
|||
