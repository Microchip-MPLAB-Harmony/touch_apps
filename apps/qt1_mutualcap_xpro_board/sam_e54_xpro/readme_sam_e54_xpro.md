...
Path of the application within the repository is **apps/qt1_mutualcap_xpro_board/sam_e54_xpro/**
...
| ----------------- | ---------------------------------------------- |
| qt1_mutualcap_xpro_board/sam_e54_xpro/sam_e54_xpro.X    | MPLABX Project for [SAM E54 Xplained Pro Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/atsame54-xpro)|
|||
