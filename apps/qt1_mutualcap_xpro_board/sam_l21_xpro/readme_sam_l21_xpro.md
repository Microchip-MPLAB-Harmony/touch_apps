...
Path of the application within the repository is **apps/qt1_mutualcap_xpro_board/sam_l21_xpro/**
...
| ----------------- | ---------------------------------------------- |
| qt1_mutualcap_xpro_board/sam_l21_xpro/sam_l21_xpro.X    | MPLABX Project for [SAM L21 Xplained Pro Evaluation Kit](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/ATSAML21-XPRO-B)|
|||
...
1. Open the application project *sam_l21_xpro.X* in the IDE
