...
extern qtm_acq_same54_node_config_t  ptc_seq_node_cfg1[DEF_NUM_CHANNELS];
...
uint8_t proj_config[PROJECT_CONFIG_DATA_LEN] = {  same5x,  (DEF_NUM_CHANNELS), (KEYS_MODULE|SCROLLER_MODULE),
...
void (*debug_func_ptr[OUTPUT_MODULE_CNT])(uint8_t ch) = {copy_run_time_data,copy_scroller_run_time_data,NULL};
...
{
	qtm_acq_same54_node_config_t *ptr = &ptc_seq_node_cfg1[channel];
...
void UART_Write(uint8_t data) {
	...
	txData = data;
	SERCOM2_USART_Write(&txData, 1); // sam devices
}
