...
{                                                                                                                  \
   Y(7)|Y(30)|Y(5)|Y(6)|Y(4), Y(8), 10,(uint8_t)PRSC_DIV_SEL_2, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
#define NODE_1_PARAMS                                                                                               \
{                                                                                                                  \
   Y(7)|Y(8)|Y(5)|Y(6)|Y(4), Y(30), 10,(uint8_t)PRSC_DIV_SEL_2, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
#define NODE_2_PARAMS                                                                                               \
{                                                                                                                  \
   Y(7)|Y(8)|Y(30)|Y(6)|Y(4), Y(5), 10,(uint8_t)PRSC_DIV_SEL_2, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
#define NODE_3_PARAMS                                                                                               \
{                                                                                                                  \
   Y(7)|Y(8)|Y(30)|Y(5)|Y(4), Y(6), 10,(uint8_t)PRSC_DIV_SEL_2, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
#define NODE_4_PARAMS                                                                                               \
{                                                                                                                  \
   Y(7)|Y(8)|Y(30)|Y(5)|Y(6), Y(4), 10,(uint8_t)PRSC_DIV_SEL_2, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
