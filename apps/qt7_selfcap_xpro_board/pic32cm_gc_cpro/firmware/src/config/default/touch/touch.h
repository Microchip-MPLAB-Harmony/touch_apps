...
{                                                                                                                  \
   Y(7)|Y(30)|Y(4)|Y(6)|Y(5), Y(8), 0,(uint8_t)PRSC_DIV_SEL_2, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_1_PARAMS                                                                                               \
{                                                                                                                  \
   Y(7)|Y(8)|Y(4)|Y(6)|Y(5), Y(30), 0,(uint8_t)PRSC_DIV_SEL_2, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_2_PARAMS                                                                                               \
{                                                                                                                  \
   Y(7)|Y(8)|Y(30)|Y(6)|Y(5), Y(4), 0,(uint8_t)PRSC_DIV_SEL_2, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_3_PARAMS                                                                                               \
{                                                                                                                  \
   Y(7)|Y(8)|Y(30)|Y(4)|Y(5), Y(6), 0,(uint8_t)PRSC_DIV_SEL_2, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_4_PARAMS                                                                                               \
{                                                                                                                  \
   Y(7)|Y(8)|Y(30)|Y(4)|Y(6), Y(5), 0,(uint8_t)PRSC_DIV_SEL_2, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
