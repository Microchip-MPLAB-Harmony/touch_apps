...
uint8_t proj_config[PROJECT_CONFIG_DATA_LEN] = {PROTOCOL_VERSION, pic32czca, TECH, (DEF_NUM_CHANNELS),
...
void UART_Write(uint8_t data) {
	...
	txData = data;
	SERCOM1_USART_Write(&txData, 1); // sam devices
}
...
void touchTuneInit(void) {
    ...
    SERCOM1_USART_Read((void *) &rxData, 1);
}
