...
#  PIC32CMLx Curiosity Example using QT7 Xplained Pro
...
1. Connect [QT7 Xplained Pro Extension Kit](https://www.microchip.com/DevelopmentTools/ProductDetails/ATQT7-XPRO) to PIC32CM LX Curiosity Pro Evaluation Kit on extension header EXT1
