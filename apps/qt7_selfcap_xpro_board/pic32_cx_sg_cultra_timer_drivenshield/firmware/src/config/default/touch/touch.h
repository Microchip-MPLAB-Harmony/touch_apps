...
{                                                                                                                  \
   X_NONE, Y(2), 10,(uint8_t)PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
#define NODE_1_PARAMS                                                                                               \
{                                                                                                                  \
   X_NONE, Y(23), 10,(uint8_t)PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
...
extern qtm_acq_pic32cxsg_node_config_t ptc_seq_node_cfg1[DEF_NUM_CHANNELS];
