 ...
 * Default value: 20.
 */
#define DEF_TOUCH_MEASUREMENT_PERIOD_MS 30
...
{                                                                                                                  \
   X(5), Y(3), 10,PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16                   \
}

#define NODE_1_PARAMS                                                                                               \
{                                                                                                                  \
   X(4), Y(3), 10,PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16                   \
}

#define NODE_2_PARAMS                                                                                               \
{                                                                                                                  \
   X(28), Y(3), 10,PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16                   \
}

#define NODE_3_PARAMS                                                                                               \
{                                                                                                                  \
   X(27), Y(3), 10,PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16                   \
}

#define NODE_4_PARAMS                                                                                               \
{                                                                                                                  \
   X(5), Y(2), 10,PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16                   \
}

#define NODE_5_PARAMS                                                                                               \
{                                                                                                                  \
   X(4), Y(2), 10,PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16                   \
}

#define NODE_6_PARAMS                                                                                               \
{                                                                                                                  \
   X(28), Y(2), 10,PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16                   \
}

#define NODE_7_PARAMS                                                                                               \
{                                                                                                                  \
   X(27), Y(2), 10,PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16                   \
}
 ...
 * Default value: 1
*/
#define DEF_TOUCH_LOWPOWER_ENABLE 1
