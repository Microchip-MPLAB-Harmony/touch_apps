var myVariable = `
{
  ...
  ,"1": {
    ...
    "content": ". Onboard Multiple Touch Button Examples . The following table provides links to documentation on how to build and run the touch example project on different development kits . Development Kit . SAMD11 Xplained Pro Development Board | .",
  ...
  ,"4": {
    ...
    "content": ". QT7 Xplained Pro Touch Examples . The following table provides links to documentation on how to build and run the touch example project on different development kits . Development Kit . SAML10 Xplained Example Development Board | .",
  ...
  ,"5": {
    ...
    "content": ". SAMC21 Xplained Sensor Example using QT1 Xplained Pro Mutual . Path of the application within the repository is apps/qt1_mutualcap_xpro_board/firmware/ . To build the application, refer to the following table and open the project using its IDE. . Touch Application . Project Name Description . qt1_mutualcap_xpro_board/firmware/sam_c21_xpro.X | MPLABX Project for SAM C21 Xplained Pro Evaluation Kit | .   |   | . Setting up the hardware . Connect the QT1 Xplained pro Mutual capacitance to the Xplained Board | Connect the Debug USB port on the board to the computer using a micro USB cable | Running the Application . Open the application project /firmware/sam_c21_xpro.X in the IDE | Build the project and program the target board | Open Data Visualizer and configure the serial port control settings as follows: Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | Config Path : | . | Select the Port from the dropdown menu and click “Connect” | Configuration files are stored as part of the project source files. Browse the ../touch/datastreamer/ project folder and click on Select Folder. |",
  ...
  ,"6": {
    "title": "SAMC21 Xplained Pro",
    "content": ". SAMC21 Xplained Sensor Example using QT1 Xplained Pro Self . Path of the application within the repository is apps/qt1_selfcap_xpro_board/firmware . To build the application, refer to the following table and open the project using its IDE. . Touch Application . Project Name Description . qt1_selfcap_xpro_board/firmware/sam_c21_xpro.X | MPLABX Project for SAM C21 Xplained Pro Evaluation Kit | .   |   | . Setting up the hardware . Connect the QT1 Xplained pro Self capacitance to the Xplained Board | Connect the Debug USB port on the board to the computer using a micro USB cable | Running the Application . Open the application project /firmware/sam_c21_xpro.X in the IDE | Build the project and program the target board | Open Data Visualizer and configure the serial port control settings as follows: Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | Config Path : | . | Select the Port from the dropdown menu and click “Connect” | Configuration files are stored as part of the project source files. Browse the ../touch/datastreamer/ project folder and click on Select Folder. |",
  ...
  ,"16": {
    "title": "SAME54 Xplained Pro",
    "content": ". SAME54 Xplained Sensor Example using QT1 Xplained Pro Mutual . Path of the application within the repository is apps/qt1_mutualcap_xpro_board/firmware/ . To build the application, refer to the following table and open the project using its IDE. . Touch Application . Project Name Description . qt1_mutualcap_xpro_board/firmware/sam_e54_xpro.X | MPLABX Project for SAM E54 Xplained Pro Evaluation Kit | .   |   | . Setting up the hardware . Connect the QT1 Xplained pro Mutual capacitance to the Xplained Board | Connect the Debug USB port on the board to the computer using a micro USB cable | Running the Application . Open the application project /firmware/sam_e54_xpro.X in the IDE | Build the project and program the target board | Open Data Visualizer and configure the serial port control settings as follows: Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | Config Path : | . | Select the Port from the dropdown menu and click “Connect” | Configuration files are stored as part of the project source files. Browse the ../touch/datastreamer/ project folder and click on Select Folder. |",
  ...
  ,"17": {
    ...
    "content": ". SAML10 Xplained Example using QT7 Xplained Pro . Path of the application within the repository is apps/qt7_selfcap_xpro_board/firmware/ . To build the application, refer to the following table and open the project using its IDE. . Hardware Setup . Connect QT7 Xplained Pro Extension Kit to SAM L10 Xplained Pro Evaluation Kit on extension header EXT1 . | Connect the Debug USB port on the board to the computer using a micro USB cable . | Running The Application . Open the application project /firmware/sam_L10_xpro.X in the IDE | Build the project and program the target board | Open Data Visualizer and configure the serial port control settings as follows: Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | Config Path : | . | Select the Port from the dropdown menu and click “Connect” | Configuration files are stored as part of the project source files. Browse the ../touch/datastreamer/ project folder and click on Select Folder. |",
  ...
  ,"19": {
    "title": "SAML21 Xplained Pro",
    "content": ". SAML21 Xplained Pro Onboard Sensor Example . Path of the application within the repository is apps/onboard_sensor/firmware/ . To build the application, refer to the following table and open the project using its IDE. . Hardware Setup . Project uses SAM L21 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable . | Running The Application . Open the application project /firmware/sam_l21_xpro.X in the IDE | Build the project and program the target board | Open Data Visualizer and configure the serial port control settings as follows: Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | Config Path : | . | Select the Port from the dropdown menu and click “Connect” | Configuration files are stored as part of the project source files. Browse the ../touch/datastreamer/ project folder and click on Select Folder. |",
  ...
  ,"21": {
    "title": "SAML22 Xplained Pro",
    "content": ". SAML22 Xplained Pro Onboard Sensor Example . Downloading and building the application . Path of the application within the repository is apps/onboard_sensor/firmware/ . To build the application, refer to the following table and open the project using its IDE. . Hardware Setup . Project uses SAM L22 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable . | Running The Application . Open the application project /firmware/sam_l22_xpro.X in the IDE | Build the project and program the target board | Open Data Visualizer and configure the serial port control settings as follows: Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | Config Path : | . | Select the Port from the dropdown menu and click “Connect” | Configuration files are stored as part of the project source files. Browse the ../touch/datastreamer/ project folder and click on Select Folder. |",
  ...
  ,"22": {
    ...
    "url": "http://localhost:4000/touch_apps/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  }
  ,"23": {
    "title": "",
    "content": ". Microchip MPLAB� Harmony 3 Touch Library Release Notes . Touch Library v3.7.0 Release . NEW DEVICES SUPPORTED . Device Support for SAM L11. | . NEW FEATURE SUPPORTED . Boost mode support (parallel acquisition) added for SAML10 and SAML11 devices. | Graphical representation of the input clock, available prescaler values, and PTC clock frequencies are displayed in the parameter tab. | The clock-change warning message, which appears when a new sensor is added, now lists the changes which happen in the background when the user selects Yes. | The minimum and maximum PTC clock frequency details are added. DEVELOPMENT TOOLS . | MPLAB X IDE v5.40 | MPLAB XC32 C/C++ Compiler v2.41 | MPLAB X IDE plug-ins: MPLAB Harmony Configurator (MHC) v3.5 | . | . Required MPLAB Harmony v3.x.x Modules . csp v3.7.1 | bsp v3.7.0 | dev_packs v3.4.1 | mhc v3.4.0 | . KNOWN ISSUES . none | .",
    "url": "http://localhost:4000/touch_apps/release_notes.html",
    "relUrl": "/release_notes.html"
  }
  ,"24": {
    "title": "Touch Applications",
    "content": ". Microchip MPLAB® Harmony 3 Touch Library . MPLAB Harmony 3 Touch Library is a royalty-free software library for developing touch applications on 32-bit microcontrollers using the Peripheral Touch Controller (PTC). Developers can use it to integrate touch-sensing capability into their applications. The library supports both self-capacitance and mutual-capacitance acquisition methods. . MPLAB Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC microcontroller and microprocessor devices. Refer to the following links for more information. . Microchip 32-bit MCUs | Microchip 32-bit MPUs | Microchip MPLAB X IDE | Microchip MPLAB Harmony | Microchip MPLAB Harmony Pages | . This repository contains the MPLAB® Harmony 3 Touch application examples . Release Notes | MPLAB® Harmony License | . To clone or download these application from Github,go to the main page of this repository and then click Clone button to clone this repo or download as zip file. This content can also be download using content manager by following these instructions . Contents Summary . Folder Description . apps | Touch example applications | . docs | Applications help documentation | . Touch Library . Refer to Touch Library Help for overview . Touch Examples . The following applications are provided to demonstrate touch applications using Touch supporting Xplained boards . Name Description . QT1 Xplained Pro Self Capacitance Extension Board | Examples using the button and scroller operation using self capacitance | . QT1 Xplained Pro Mutual Capacitance Extension Board | Examples usings the button and scroller operation using mutual capacitance | . QT7 Xplained Pro Extension Board | Examples using the QT7 water tolerant and robust touch board | . Onboard Sensors - Single Button Development Boards | Examples using single onboard button on the Xplained / xplained mini boards | . Onboard Sensors - Multiple Button Development Boards | Examples using multiple onboard button on the Xplained / xplained mini boards | . Please refer to the Touch Modular Library Userguide available in the link below for further information. . | Also, refer to the microchip developer pages listed under “Harmony 3 Touch Configurator” &gt; Step by Step Examples &gt; Set Up the Environment for detailed information regarding configuring touch projects in Harmony framework. . | For licensing information about contents of this module, please refer to MPLAB Harmony License. . | For more information about the latest release, please refer to Release Notes. . | .",
